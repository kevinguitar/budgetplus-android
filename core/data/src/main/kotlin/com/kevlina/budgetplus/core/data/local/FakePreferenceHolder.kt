...
private class FakePreference(
    ...
    override val pref: SharedPreferences = object : SharedPreferences {
        ...
        override fun getStringSet(key: String?, defValues: MutableSet<String>?): MutableSet<String>? = error("Not supported")
        ...
        override fun registerOnSharedPreferenceChangeListener(listener: SharedPreferences.OnSharedPreferenceChangeListener?) = error("Not supported")
        override fun unregisterOnSharedPreferenceChangeListener(listener: SharedPreferences.OnSharedPreferenceChangeListener?) = error("Not supported")
    }
